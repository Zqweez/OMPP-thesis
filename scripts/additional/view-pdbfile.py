...
# ===== SETTINGS =====
pdb_dir = Path("data/other-pdb")

pdb_files = sorted(pdb_dir.glob("*.pdb"))


def make_cloud_view(pdb_file: Path, output_dir: Path):
...
def make_bone_view(pdb_file: Path, output_dir: Path):
    png_file = output_dir / f"{pdb_file.stem}.png"
    pdf_file = output_dir / f"{pdb_file.stem}.pdf"
...
cloud_output_dir = Path("outputs/pdb-view/front-page")
cloud_output_dir.mkdir(parents=True, exist_ok=True)
bone_output_dir = Path("outputs/pdb-view/bone-view")
bone_output_dir.mkdir(parents=True, exist_ok=True)

for pdb_file in pdb_files: 
    # make_cloud_view(pdb_file, cloud_output_dir)
    make_bone_view(pdb_file, bone_output_dir)
